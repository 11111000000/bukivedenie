import{m as _,b as x,a as q,f,p as y}from"./shared-DIh12-4I.js";/* empty css              */_(x({title:"Война и мир — Персонажи (связи)",subtitle:"Сеть показывает, кто с кем чаще связан в тексте. Узлы крупнее у более заметных персонажей, а линии помогают увидеть силу пересечений и группировки.",controls:`
      <label>Поиск
