...
export const api = {
  ...
  bookIndex: (book) => fetchJson(`/api/book_index?book=${encodeURIComponent(book)}`),
  chapterStats: (book) => fetchJson(`/api/chapter_stats?book=${encodeURIComponent(book)}`),
  compareBooks: (a,b) => fetchJson(`/api/compare_books?a=${encodeURIComponent(a)}&b=${encodeURIComponent(b)}`),
  motifSeries: (book, term) => fetchJson(`/api/motif_series?book=${encodeURIComponent(book)}&term=${encodeURIComponent(term)}`),
